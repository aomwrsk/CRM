...
print_r($_POST);
$channels = isset($_POST['inputChannel']) ? $_POST['inputChannel'] : NULL;
$inputSocial = isset($_POST['inputSocial']) ? $_POST['inputSocial'] : NULL;
$inputContract = isset($_POST['inputContract']) ? $_POST['inputContract'] : NULL;
$inputSearch = isset($_POST['inputSearch']) ? $_POST['inputSearch'] : NULL;
$inputAP_No = isset($_POST['inputAP_No']) ? $_POST['inputAP_No'] : NULL;
$inputFac_no = isset($_POST['inputFac_no']) ? $_POST['inputFac_no'] : NULL;
$inputFac_name = isset($_POST['inputFac_name']) ? $_POST['inputFac_name'] : NULL;
$inputFac_nation = isset($_POST['inputFac_nation']) ? $_POST['inputFac_nation'] : NULL;
$inputFac_type = isset($_POST['inputFac_type']) ? $_POST['inputFac_type'] : NULL;
$inputFac_value = isset($_POST['inputFac_value']) ? $_POST['inputFac_value'] : NULL;
$inputDate = isset($_POST['inputDate']) ? $_POST['inputDate'] : NULL;
$inputAddress = isset($_POST['inputAddress']) ? $_POST['inputAddress'] : NULL;
$province_code = isset($_POST['inputProvince']) ? $_POST['inputProvince'] : NULL;
...
$inputCustomer = isset($_POST['inputCustomer']) ? $_POST['inputCustomer'] : NULL;
$inputPosition = isset($_POST['inputPosition']) ? $_POST['inputPosition'] : NULL;
$inputEmail = isset($_POST['inputEmail']) ? $_POST['inputEmail'] : NULL;
$inputTel = isset($_POST['inputTel']) ? $_POST['inputTel'] : NULL;
$inputSegment = isset($_POST['inputSegment']) ? $_POST['inputSegment'] : NULL;
$inputCL_type = isset($_POST['inputCL_type']) ? $_POST['inputCL_type'] : '00'; // With default '00'
$inputSales = isset($_POST['inputSales']) ? $_POST['inputSales'] : NULL;
$inputAppoint = isset($_POST['inputAppoint']) ? $_POST['inputAppoint'] : NULL;
$inputVisit = isset($_POST['inputVisit']) ? $_POST['inputVisit'] : NULL;
$inputCus_status = isset($_POST['inputCus_status']) ? $_POST['inputCus_status'] : NULL;
$inputInsight = isset($_POST['inputInsight']) ? $_POST['inputInsight'] : NULL;
$inputCompetitor_name = isset($_POST['inputCompetitor_name']) ? $_POST['inputCompetitor_name'] : NULL;
$inputCompetitor_value = isset($_POST['inputCompetitor_value']) ? $_POST['inputCompetitor_value'] : NULL;
$inputis_status = isset($_POST['inputis_status']) ? $_POST['inputis_status'] : NULL;
$inputReason = isset($_POST['inputReason']) ? $_POST['inputReason'] : NULL;
$inputRemark = isset($_POST['inputRemark']) ? $_POST['inputRemark'] : NULL;
}
$call = 'CO';
$code = 'AP';
$time =  time();
...
if($fpfix === $pfix){
    $strSQL = "INSERT INTO [dbo].[appoint_head]
           ...
           , ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
           , ?)"; 
    $params = array( $uid, $record_datetime, $uid, $record_datetime, $appoint_no, $inputDate, $inputVisit, $call_no, $inputDate, $inputFac_no,
    ...
    /*$strSQL1 = "INSERT INTO appoint_follow ([record_id]
           ...
           ,[follow_detail]
           ,[is_prospect]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"; 
    $params = array( $uid, $record_datetime, $uid, $record_datetime, $appoint_no, 1, $record_datetime, NULL, $inputCus_status);
    ...
    , ?, ?, ?, ?, ?, ?, ?, ?, ?, ?
    , ?)"; 
$params = array( $uid, $record_datetime, $uid, $record_datetime, $appoint_new, $inputDate, $inputVisit, $call_new, $inputDate, $inputFac_no, $inputFac_name, $province
...
$objQuery = sqlsrv_query($objCon, $strSQL, $params);
    ...
    ,[follow_detail]
    ,[is_prospect]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"; 
$params = array( $uid, $record_datetime, $uid, $record_datetime, $appoint_new, 1, $record_datetime, NULL, $inputCus_status);
$objQuery1 = sqlsrv_query($objCon, $strSQL1, $params);
}
if ($objQuery === false) {
    die(print_r(sqlsrv_errors(), true));
