    ...
    <div class="card-body">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ps-3">
          ...
          <span id="container_value" class="text-success large pt-1 fw-bold"></span> <span class="text-muted small pt-2 ps-1">THB</span>
...
<div class="col-xxl-5 col-md-6">
  <div class="card info-card revenue-card">
    ...
    <div class="card-body">
      <h5 class="card-title">ค่าซ่อมรถ</h5>
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="ps-3">
          <h6 id="vehicle_number"></h6>
          <span id="vehicle_value" class="text-success large pt-1 fw-bold"></span> <span class="text-muted small pt-2 ps-1">THB</span>
